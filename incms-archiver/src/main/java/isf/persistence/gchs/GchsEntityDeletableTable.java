...
// ARQv10
// Class: GchsEntityDeletableTable
// Table: GCHS_ENTITY_DELETABLE_TABLE
...
/**
 * Persistent class for table:GCHS_ENTITY_DELETABLE_TABLE
 ...
 * <tr><td><input disabled type="checkbox" checked></td><td>id_ent_del_table</td><td>LONG</td><td></td></tr>
 ...
 * 	Table specification:
 * 		name: GCHS_ENTITY_DELETABLE_TABLE
 * 		owner: INCMS_ARCHIVE
 * 	General options:
 ...
 */
public class GchsEntityDeletableTable
implements java.io.Serializable, java.lang.Cloneable
{
	/** Serial UID */
	private static final long serialVersionUID=5985228928L;

	/** Static SQL sentence: INSERT (all columns). */
	private static final java.lang.String SQL_INSERT_ALL="INSERT /*INSERT_ALL*/ INTO GCHS_ENTITY_DELETABLE_TABLE(CREATE_DATE,UPDATE_DATE,UPDATE_USER,UPDATE_PROGRAM,ID_ENT_DEL_TABLE,ID_ENTITY,TABLE_NAME,OPTIMIST_LOCK) VALUES(?,?,?,?,SEC_GCHS_ENTITYDELETABLETABLE1.NEXTVAL,?,?,?)";

	/** Static SQL sentence: DELETE. */
	private static final java.lang.String SQL_DELETE="DELETE /*DELETE*/ FROM GCHS_ENTITY_DELETABLE_TABLE WHERE ID_ENT_DEL_TABLE=? AND OPTIMIST_LOCK=?";

	/** Static SQL sentence: UPDATE (all columns) for BATCH operation. */
	private static final java.lang.String SQL_UPDATE_BATCH="UPDATE /*UPDATE_BATCH*/ GCHS_ENTITY_DELETABLE_TABLE SET CREATE_DATE= ? , UPDATE_DATE= ? , UPDATE_USER= ? , UPDATE_PROGRAM= ? , ID_ENTITY= ? , TABLE_NAME= ? , OPTIMIST_LOCK= ?  WHERE ID_ENT_DEL_TABLE=? AND OPTIMIST_LOCK=?";

	/** Static SQL sentence: INSERT (all columns) for BATCH operation. */
	private static final java.lang.String SQL_INSERT_BATCH="INSERT /*INSERT_BATCH*/ INTO GCHS_ENTITY_DELETABLE_TABLE(CREATE_DATE,UPDATE_DATE,UPDATE_USER,UPDATE_PROGRAM,ID_ENT_DEL_TABLE,ID_ENTITY,TABLE_NAME,OPTIMIST_LOCK) VALUES(?,?,?,?,?,?,?,?)";

	/** Static SQL sentence: SELECT. */
	private static final java.lang.String SQL_READ="SELECT /*READ*/ * FROM GCHS_ENTITY_DELETABLE_TABLE WHERE ID_ENT_DEL_TABLE=?";

	/** Cache (indexed by {ID_ENT_DEL_TABLE}) */
	private static isf.persistence.ReadonlyCache<java.lang.Long,GchsEntityDeletableTable> pkCache=new isf.persistence.ReadonlyCache<java.lang.Long,GchsEntityDeletableTable>(200, 10000);
	...
	/** Column 'ID_ENT_DEL_TABLE'. */
	private long myIdEntDelTable;
	 ...
	 */
	@java.lang.Override
	public GchsEntityDeletableTable clone()
	throws
	...
	/**
	 * Get the value of the property IdEntDelTable.
	 * @return Value of column 'ID_ENT_DEL_TABLE'.
	 */
	public long getIdEntDelTable()
	{
		return this.myIdEntDelTable;
	}

	/**
	 * Set the value of the property IdEntDelTable.
	 * @param pIdEntDelTable Value for columnSetup 'ID_ENT_DEL_TABLE'.
	 */
	public void setIdEntDelTable(final long pIdEntDelTable)
	{
		this.myIdEntDelTable=pIdEntDelTable;
	...
	{
		return "GchsEntityDeletableTable:{CREATE_DATE="+this.myCreateDate+", UPDATE_DATE="+this.myUpdateDate+", UPDATE_USER="+(this.myUpdateUser==null ? null : (this.myUpdateUser.length()<20 ? this.myUpdateUser : this.myUpdateUser.substring(0, 20)+"..."))+", UPDATE_PROGRAM="+(this.myUpdateProgram==null ? null : (this.myUpdateProgram.length()<20 ? this.myUpdateProgram : this.myUpdateProgram.substring(0, 20)+"..."))+", OPTIMIST_LOCK="+this.myOptimistLock+", ID_ENT_DEL_TABLE="+this.myIdEntDelTable+", ID_ENTITY="+this.myIdEntity+", TABLE_NAME="+(this.myTableName==null ? null : (this.myTableName.length()<20 ? this.myTableName : this.myTableName.substring(0, 20)+"..."))+"}";
	}
	 ...
	 */
	public GchsEntityDeletableTable copy()
	{
		GchsEntityDeletableTable gchsEntityDeletableTable=new GchsEntityDeletableTable();
		// CREATE_DATE (DATE):
		if (isNullCreateDate())
		{
			gchsEntityDeletableTable.setNullCreateDate();
		}
		else
		{
			gchsEntityDeletableTable.setCreateDate(new java.sql.Date(getCreateDate().getTime()));
		}
		
		// UPDATE_DATE (DATE):
		if (isNullUpdateDate())
		{
			gchsEntityDeletableTable.setNullUpdateDate();
		}
		else
		{
			gchsEntityDeletableTable.setUpdateDate(new java.sql.Date(getUpdateDate().getTime()));
		}
		
		// UPDATE_USER (STRING):
		if (isNullUpdateUser())
		{
			gchsEntityDeletableTable.setNullUpdateUser();
		}
		else
		{
			gchsEntityDeletableTable.setUpdateUser(getUpdateUser());
		}
		
		// UPDATE_PROGRAM (STRING):
		if (isNullUpdateProgram())
		{
			gchsEntityDeletableTable.setNullUpdateProgram();
		}
		else
		{
			gchsEntityDeletableTable.setUpdateProgram(getUpdateProgram());
		}
		
		// OPTIMIST_LOCK (LONG):
		if (isNullOptimistLock())
		{
			gchsEntityDeletableTable.setNullOptimistLock();
		}
		else
		{
			gchsEntityDeletableTable.setOptimistLock(getOptimistLock());
		}
		
		// ID_ENT_DEL_TABLE (LONG):
		if (isNullIdEntDelTable())
		{
			gchsEntityDeletableTable.setNullIdEntDelTable();
		}
		else
		{
			gchsEntityDeletableTable.setIdEntDelTable(getIdEntDelTable());
		}
		
		// ID_ENTITY (LONG):
		if (isNullIdEntity())
		{
			gchsEntityDeletableTable.setNullIdEntity();
		}
		else
		{
			gchsEntityDeletableTable.setIdEntity(getIdEntity());
		}
		
		// TABLE_NAME (STRING):
		if (isNullTableName())
		{
			gchsEntityDeletableTable.setNullTableName();
		}
		else
		{
			gchsEntityDeletableTable.setTableName(getTableName());
		}
		
		return gchsEntityDeletableTable;
	}
	...
	/**
	 * Checks if the property myIdEntDelTable has been modified since last reset (instantiation, read, insert or update).
	 * @return true only if the property has been modified.
	 */
	public boolean isModifiedIdEntDelTable()
	{
		return ((this.flagsMod & 0x20)!=0);
	}

	/**
	 * Checks if the last value readed for the property myIdEntDelTable is null.
	 * @return true only if the value is null.
	 */
	public boolean isNullIdEntDelTable()
	{
		return ((this.flagsNul & 0x20)!=0);
	}

	/**
	 * Set the value of the property myIdEntDelTable to null.
	 */
	public void setNullIdEntDelTable()
	{
		this.myIdEntDelTable=0L;
		this.flagsNul|=0x20;
		this.flagsMod|=0x20;
	}
	 ...
	 * @return The new object.
	 */
	public GchsEntityDeletableTable copyWithoutPk()
	{
		GchsEntityDeletableTable gchsEntityDeletableTable=new GchsEntityDeletableTable();
		// CREATE_DATE (DATE):
		if (isNullCreateDate())
	 ...
	 * @param pIdEntDelTable Value for field IdEntDelTable.
	 * @return Read object
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	private static GchsEntityDeletableTable readFromJDBC(final java.sql.Connection connection, final long pIdEntDelTable)
	throws
		java.sql.SQLException
	{
		...
		try
		{
			ps.setLong(p, pIdEntDelTable);
			p++;
			rs=ps.executeQuery();
			GchsEntityDeletableTable gchsEntityDeletableTable;
			if (rs.next())
			{
				gchsEntityDeletableTable=new GchsEntityDeletableTable();
				gchsEntityDeletableTable.loadResultSet(rs);
			}
			else
			{
				gchsEntityDeletableTable=null;
			}
			return gchsEntityDeletableTable;
		}
		finally
		...
		java.sql.SQLException
	{
		...
		// ID_ENT_DEL_TABLE
		this.myIdEntDelTable=rs.getLong("ID_ENT_DEL_TABLE");
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static java.util.Vector<GchsEntityDeletableTable> search(final java.sql.Connection connection, final java.lang.String where, final java.lang.String order)
	throws
		java.sql.SQLException
	{
		final java.lang.String sql1="SELECT /*SEARCH*/ * FROM GCHS_ENTITY_DELETABLE_TABLE";
		...
		java.util.Collection<GchsEntityDeletableTable> collection = loadSQL(connection, sql1, sql2, new java.util.Vector<GchsEntityDeletableTable>());
		return (collection instanceof java.util.Vector) ? (java.util.Vector<GchsEntityDeletableTable>)collection : new java.util.Vector<GchsEntityDeletableTable>(collection);
	}
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static java.util.Collection<GchsEntityDeletableTable> collect(final java.sql.Connection connection, final java.lang.String where, final java.lang.String order, java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException
	{
		final java.lang.String sql1="SELECT /*SEARCH*/ * FROM GCHS_ENTITY_DELETABLE_TABLE";
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static isf.persistence.ISQLIterator<GchsEntityDeletableTable> searchIterator(final java.sql.Connection connection, final java.lang.String where, final java.lang.String order)
	throws
		java.sql.SQLException
	{
		final java.lang.String sql1="SELECT /*ITERATOR*/ * FROM GCHS_ENTITY_DELETABLE_TABLE";
		java.lang.String sql2="";
		if (where!=null && where.trim().length()>0)
		{
			sql2+=" WHERE "+where;
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static isf.persistence.ISQLIterator<GchsEntityDeletableTable> searchIterator(final java.sql.Connection connection, final java.lang.String where, final java.lang.String order, final isf.persistence.IArguments arguments)
	throws
		java.sql.SQLException
	{
		try
		{
			final java.lang.String sql1="SELECT /*ITERATOR_ARGS*/ * FROM GCHS_ENTITY_DELETABLE_TABLE";
			java.lang.String sql2="";
			if (where!=null && where.trim().length()>0)
			{
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	private static java.util.Collection<GchsEntityDeletableTable> loadSQLFromJDBC(final java.sql.Connection connection, final java.lang.String sql1, final java.lang.String sql2, java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException
	{
		if (collection==null)
		{
			collection=new java.util.ArrayList<GchsEntityDeletableTable>();
		}
		final java.lang.String sql=(sql2.length()==0) ? sql1 : sql1+sql2;
		java.sql.PreparedStatement st=connection.prepareStatement(sql);
		java.sql.ResultSet rs=null;
		try
		{
			...
			while (rs.next())
			{
				gchsEntityDeletableTable=new GchsEntityDeletableTable();
				gchsEntityDeletableTable.loadResultSet(rs);
				collection.add(gchsEntityDeletableTable);
			}
		}
		finally
		{
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	private static java.util.Collection<GchsEntityDeletableTable> loadSQL(final java.sql.Connection connection, final java.lang.String sql1, final java.lang.String sql2, final isf.persistence.IArguments arguments, java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException
	{
		if (collection==null)
		...
		{
			isf.util.gcqs.advanced.spec.QuerySpec query=new isf.util.gcqs.advanced.spec.QuerySpec("Table GCHS_ENTITY_DELETABLE_TABLE", sql);
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	private static void resultsetToBeans(final java.sql.ResultSet rs, final java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException
	{
		while (rs.next())
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static java.util.Vector<GchsEntityDeletableTable> search(final java.sql.Connection connection, final java.lang.String where, final java.lang.String order, final isf.persistence.IArguments arguments)
	throws
		java.sql.SQLException
	{
		try
		{
			final java.lang.String sql1="SELECT /*SEARCH_ARGS*/ * FROM GCHS_ENTITY_DELETABLE_TABLE";
			java.lang.String sql2="";
			if (where!=null && where.trim().length()>0)
			{
				String sqlTransformed = isf.util.gcqs.advanced.exec.SessionFilterHelper.transformSql(connection.getMetaData().getDatabaseProductName(), where);
			...
			java.util.Collection<GchsEntityDeletableTable> collection = loadSQL(connection, sql1, sql2, arguments, new java.util.Vector<GchsEntityDeletableTable>());
			return (collection instanceof java.util.Vector) ? (java.util.Vector<GchsEntityDeletableTable>)collection : new java.util.Vector<GchsEntityDeletableTable>(collection);
		}
		catch (isf.util.GcqsQuerySystemException e)
		{
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static java.util.Collection<GchsEntityDeletableTable> collect(final java.sql.Connection connection, final java.lang.String where, final java.lang.String order, final isf.persistence.IArguments arguments, java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException
	{
		try
	...
	throws
		java.sql.SQLException
	{
		final java.lang.String sql1="SELECT /*SUM*/ SUM("+columnName+") FROM GCHS_ENTITY_DELETABLE_TABLE";
		java.lang.String sql2="";
		if (where!=null && where.trim().length()>0)
		{
			sql2+=" WHERE "+where;
	...
	throws
		java.sql.SQLException
	{
		final java.lang.String sql1="SELECT /*SUM_ARGS*/ SUM("+columnName+") FROM GCHS_ENTITY_DELETABLE_TABLE";
		java.lang.String sql2="";
		if (where!=null && where.trim().length()>0)
		{
			sql2+=" WHERE "+where;
	...
	/**
	 * Sumatory of value of the property IdEntDelTable.
	 * @param connection JDBC connection.
	 * @param where SQL condition.
	 * @return Summatory.
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static double sumIdEntDelTable(final java.sql.Connection connection, final java.lang.String where)
	throws
		java.sql.SQLException
	{
		return sumByCriteria(connection, where, "ID_ENT_DEL_TABLE");
	}
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static double sumIdEntDelTable(final java.sql.Connection connection, final java.lang.String where, final isf.persistence.IArguments arguments)
	throws
		java.sql.SQLException
	{
		return sumByCriteria(connection, where, "ID_ENT_DEL_TABLE", arguments);
	}
	...
	throws
		java.sql.SQLException
	{
		final java.lang.String sql1="SELECT /*COUNT*/ COUNT(*) FROM GCHS_ENTITY_DELETABLE_TABLE";
		java.lang.String sql2="";
		if (where!=null && where.trim().length()>0)
		{
			sql2+=" WHERE "+where;
	...
	throws
		java.sql.SQLException
	{
		final java.lang.String sql1="SELECT /*COUNT_ARGS*/ COUNT(*) FROM GCHS_ENTITY_DELETABLE_TABLE";
		java.lang.String sql2="";
		if (where!=null && where.trim().length()>0)
		{
			sql2+=" WHERE "+where;
	...
	throws
		java.sql.SQLException
	{
		java.lang.String sql="SELECT /*FUNCTION*/ "+function+"("+columnName+") FROM GCHS_ENTITY_DELETABLE_TABLE";
		if (where!=null && where.trim().length()>0)
		{
			sql+=" WHERE "+where;
		}
	...
	throws
		java.sql.SQLException
	{
		java.lang.String sql="SELECT /*FUNCTION_ARGS*/ "+function+"("+columnName+") FROM GCHS_ENTITY_DELETABLE_TABLE";
		if (where!=null && where.trim().length()>0)
		{
			sql+=" WHERE "+where;
		}
		...
		isf.persistence.GcgcCorruptedRegisterException
	{
		...
		{
			GchsEntityDeletableTable gchsEntityDeletableTable=read(connection, getIdEntDelTable());
			if (gchsEntityDeletableTable != null)
			{
				setOptimistLock(gchsEntityDeletableTable.getOptimistLock());
			}
		}
		...
		try
		{
			...
			// WHERE: ID_ENT_DEL_TABLE (LONG):
			ps.setLong(p, myIdEntDelTable);
			p++;
			...
			{
				throw new isf.persistence.GcgcCorruptedRegisterException("No rows deleted in table GCHS_ENTITY_DELETABLE_TABLE with PK {"+"ID_ENT_DEL_TABLE="+this.myIdEntDelTable+",OPTIMIST_LOCK="+this.myOptimistLock+"}");
			}
		}
		finally
		{
		...
		isf.persistence.GcgcCorruptedRegisterException
	{
		...
		java.lang.StringBuilder set=new java.lang.StringBuilder(135);
		char separator=' ';
		...
		if (hasUpdatableColumns)
		{
			...
			java.lang.StringBuilder sentence=new java.lang.StringBuilder("UPDATE /*UPDATE*/ GCHS_ENTITY_DELETABLE_TABLE SET ".length()+set.length()+" WHERE ".length()+"ID_ENT_DEL_TABLE=? AND OPTIMIST_LOCK=?".length());
			sentence.append("UPDATE /*UPDATE*/ GCHS_ENTITY_DELETABLE_TABLE SET ").append(set).append(" WHERE ").append("ID_ENT_DEL_TABLE=? AND OPTIMIST_LOCK=?");
			...
			try
			{
				...
				if (ps.executeUpdate()==0)
				{
					throw new isf.persistence.GcgcCorruptedRegisterException("No rows updated in table GCHS_ENTITY_DELETABLE_TABLE with PK {"+"ID_ENT_DEL_TABLE="+this.myIdEntDelTable+",OPTIMIST_LOCK="+this.myOptimistLock+"}");
				}
				this.myOptimistLock=pOptimistLock;
			}
			finally
		...
		java.sql.SQLException
	{
		...
		java.lang.StringBuilder columns=new java.lang.StringBuilder(119);
		...
		// SQL: ID_ENT_DEL_TABLE (LONG):
		if (((this.flagsNul & 0x20)!=0))
		{
			columns.append(separator).append("ID_ENT_DEL_TABLE");
			values.append(separator).append("SEC_GCHS_ENTITYDELETABLETABLE1.NEXTVAL");
			separator=',';
			sequencesExpected.add("ID_ENT_DEL_TABLE");
		}
		...
		values.append(separator).append('?');
		separator=',';
		java.lang.StringBuilder sentence=new java.lang.StringBuilder(62+columns.length()+values.length());
		sentence.append("INSERT /*INSERT*/ INTO GCHS_ENTITY_DELETABLE_TABLE(").append(columns).append(") VALUES (").append(values).append(')');
		java.lang.String sql=sentence.toString();
		...
		try
		{
			...
			if (((this.flagsMod & 0x20)!=0))
			{
				...
				{
					ps.setLong(p, this.myIdEntDelTable);
				}
				p++;
			}
			// SET: ID_ENTITY (LONG):
			...
			if (ps.executeUpdate()==1)
			{
				if (sequencesExpected.size()>0)
				{
					...
					rsSequences.next();
					setIdEntDelTable(rsSequences.getLong(1));
					rsSequences.close();
				}
			}
		}
		...
		java.sql.SQLException
	{
		...
		{
			java.lang.String[] sequencesExpected=new java.lang.String[] { "ID_ENT_DEL_TABLE"};
	 ...
	 * @param connection JDBC connection.
	 * @param collection Collection of GchsEntityDeletableTable objects.
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 * @exception isf.persistence.NotAllRecordsSuccesfullyBatchedException If not all objects were succesfully inserted.
	 */
	public static void insertBatch(final java.sql.Connection connection, final java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException,
		isf.persistence.NotAllRecordsSuccesfullyBatchedException
	{
		...
		{
			for (java.util.Iterator<GchsEntityDeletableTable> iterator=collection.iterator();iterator.hasNext();)
			{
				GchsEntityDeletableTable gchsEntityDeletableTable=iterator.next();
				gchsEntityDeletableTable.insertAll(connection);
			}
		}
	}
	 ...
	 * @exception isf.persistence.NotAllRecordsSuccesfullyBatchedException If not all objects were succesfully inserted.
	 */
	public static void updateBatch(final java.sql.Connection connection, final java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException,
		isf.persistence.NotAllRecordsSuccesfullyBatchedException
	{
		...
		try
		{
			for (java.util.Iterator<GchsEntityDeletableTable> iterator=collection.iterator();iterator.hasNext();)
			{
				...
				long currentTimeMillis=java.lang.System.currentTimeMillis();
				java.sql.Date sqlDateCurrentTimeMillis=new java.sql.Date(currentTimeMillis);
				if (!((gchsEntityDeletableTable.flagsMod & 0x2)!=0))
				{
					gchsEntityDeletableTable.setUpdateDate(sqlDateCurrentTimeMillis);
				}
				int p=1;
				// SQL: CREATE_DATE (DATE):
				if (gchsEntityDeletableTable.isNullCreateDate())
				{
					ps.setNull(p, java.sql.Types.DATE);
				}
				else
				{
					ps.setTimestamp(p, new java.sql.Timestamp(gchsEntityDeletableTable.myCreateDate.getTime()));
				}
				p++;
				// SQL: UPDATE_DATE (DATE):
				if (gchsEntityDeletableTable.isNullUpdateDate())
				{
					ps.setNull(p, java.sql.Types.DATE);
				}
				else
				{
					ps.setTimestamp(p, new java.sql.Timestamp(gchsEntityDeletableTable.myUpdateDate.getTime()));
				}
				p++;
				// SQL: UPDATE_USER (STRING):
				if (gchsEntityDeletableTable.isNullUpdateUser())
				{
					ps.setNull(p, java.sql.Types.VARCHAR);
				}
				else
				{
					ps.setString(p, gchsEntityDeletableTable.myUpdateUser);
				}
				p++;
				// SQL: UPDATE_PROGRAM (STRING):
				if (gchsEntityDeletableTable.isNullUpdateProgram())
				{
					ps.setNull(p, java.sql.Types.VARCHAR);
				}
				else
				{
					ps.setString(p, gchsEntityDeletableTable.myUpdateProgram);
				}
				p++;
				// SQL: ID_ENTITY (LONG):
				if (gchsEntityDeletableTable.isNullIdEntity())
				{
					ps.setNull(p, java.sql.Types.NUMERIC);
				}
				else
				{
					ps.setLong(p, gchsEntityDeletableTable.myIdEntity);
				}
				p++;
				// SQL: TABLE_NAME (STRING):
				if (gchsEntityDeletableTable.isNullTableName())
				{
					ps.setNull(p, java.sql.Types.VARCHAR);
				}
				else
				{
					ps.setString(p, gchsEntityDeletableTable.myTableName);
				}
				p++;
				// Columna OPTIMIST_LOCK (dentro del SET):
				long pOptimistLock=(gchsEntityDeletableTable.myOptimistLock < 99) ? gchsEntityDeletableTable.myOptimistLock + 1 : 1;
				ps.setLong(p, pOptimistLock);
				p++;
				
				// Columnas PK:
				// WHERE: ID_ENT_DEL_TABLE (LONG):
				ps.setLong(p, gchsEntityDeletableTable.myIdEntDelTable);
				p++;
				
				// WHERE: OPTIMIST_LOCK (LONG):
				ps.setLong(p, gchsEntityDeletableTable.myOptimistLock);
				p++;
			...
			java.util.Collection<GchsEntityDeletableTable> recordsFailed = new java.util.ArrayList<GchsEntityDeletableTable>();
			final java.util.Iterator<GchsEntityDeletableTable> iterator=collection.iterator();
			for (int i = 0; i < recordsUpdated.length && iterator.hasNext(); i++)
			{
				final GchsEntityDeletableTable gchsEntityDeletableTable=iterator.next();
				if (recordsUpdated[i]==1 || recordsUpdated[i]==java.sql.PreparedStatement.SUCCESS_NO_INFO)
				{
					long pOptimistLock=(gchsEntityDeletableTable.myOptimistLock < 99) ? gchsEntityDeletableTable.myOptimistLock + 1 : 1;
					gchsEntityDeletableTable.myOptimistLock=pOptimistLock;
					gchsEntityDeletableTable.resetModifiedFlags();
					updateCount++;
					
				}
				else
				{
					recordsFailed.add(gchsEntityDeletableTable);
				}
			}
			
			if (!recordsFailed.isEmpty())
			{
				isf.persistence.NotAllRecordsSuccesfullyBatchedException notAllRecordsSuccesfullyBatchedEx = new isf.persistence.NotAllRecordsSuccesfullyBatchedException("GCHS_ENTITY_DELETABLE_TABLE", collection.size(), updateCount, collection);
	 ...
	 */
	public static void deleteBatch(final java.sql.Connection connection, java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException,
		isf.persistence.NotAllRecordsSuccesfullyBatchedException
	{
		...
		try
		{
			...
			{
				throw new isf.persistence.NotAllRecordsSuccesfullyBatchedException("GCHS_ENTITY_DELETABLE_TABLE", collection.size(), ps.getUpdateCount(), collection);
			}
		}
		finally
		{
		...
		java.sql.SQLException
	{
		...
		try
		{
			synchronized (GchsEntityDeletableTable.class)
			{
	 ...
	 * @exception isf.persistence.NotAllRecordsSuccesfullyBatchedException If not all objects were succesfully inserted.
	 */
	private static void optimizedInsertBatch(final java.sql.Connection connection, final java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException,
		isf.persistence.NotAllRecordsSuccesfullyBatchedException
	{
		java.sql.PreparedStatement ps=connection.prepareStatement(SQL_INSERT_BATCH);
		long sequence5=(cacheSequenceRange(connection , "SEC_GCHS_ENTITYDELETABLETABLE1" , collection.size())) - collection.size() + 1;
		try
		{
			for (java.util.Iterator<GchsEntityDeletableTable> iterator=collection.iterator();iterator.hasNext();)
			{
				...
				long currentTimeMillis=java.lang.System.currentTimeMillis();
				java.sql.Date sqlDateCurrentTimeMillis=new java.sql.Date(currentTimeMillis);
				if (!((gchsEntityDeletableTable.flagsMod & 0x1)!=0))
				{
					gchsEntityDeletableTable.setCreateDate(sqlDateCurrentTimeMillis);
				}
				if (!((gchsEntityDeletableTable.flagsMod & 0x2)!=0))
				{
					gchsEntityDeletableTable.setUpdateDate(sqlDateCurrentTimeMillis);
				...
				p++;
				// SQL: ID_ENT_DEL_TABLE (LONG):
				gchsEntityDeletableTable.setIdEntDelTable(sequence5++);
				{
					ps.setLong(p, gchsEntityDeletableTable.myIdEntDelTable);
				}
				p++;
				...
				// SQL: OPTIMIST_LOCK (LONG):
				ps.setLong(p, 1);
				gchsEntityDeletableTable.setOptimistLock(1);
				ps.addBatch();
			}
			ps.executeBatch();
			if (ps.getUpdateCount()!=collection.size())
			...
			{
				for (final java.util.Iterator<GchsEntityDeletableTable> iterator=collection.iterator();iterator.hasNext();)
				{
					final GchsEntityDeletableTable gchsEntityDeletableTable=iterator.next();
					gchsEntityDeletableTable.resetModifiedFlags();
				}
	 ...
	 * @param gchsEntityDeletableTable Persistence object.
	 */
	private static void putObjectInCaches(GchsEntityDeletableTable gchsEntityDeletableTable)
	{
		// Almacenar el objeto en la caché principal:
		pkCache.put(java.lang.Long.valueOf(gchsEntityDeletableTable.myIdEntDelTable), gchsEntityDeletableTable);
	}
		...
		java.sql.SQLException
	{
		...
		// Vaciar caché:
		pkCache.reset();
		java.sql.PreparedStatement st=connection.prepareStatement("SELECT /*LOAD_CACHE*/ * FROM GCHS_ENTITY_DELETABLE_TABLE");
		java.sql.ResultSet rs=null;
		try
		{
			st.setFetchSize(100);
			...
			for (int i=0;rs.next() && i<10000;)
			{
				...
				gchsEntityDeletableTable=new GchsEntityDeletableTable();
				gchsEntityDeletableTable.loadResultSet(rs);
				putObjectInCaches(gchsEntityDeletableTable);
			}
		}
		finally
		{
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	private static GchsEntityDeletableTable readFromCache(final java.sql.Connection connection, final long pIdEntDelTable)
	throws
		java.sql.SQLException
	{
		synchronized(pkCache)
		...
		GchsEntityDeletableTable gchsEntityDeletableTable=(GchsEntityDeletableTable)pkCache.get(java.lang.Long.valueOf(pIdEntDelTable));
		if (gchsEntityDeletableTable==null)
		{
			synchronized(pkCache)
			{
				gchsEntityDeletableTable=(GchsEntityDeletableTable)pkCache.get(java.lang.Long.valueOf(pIdEntDelTable));
				if (gchsEntityDeletableTable==null && pkCache.size()==10000)
				{
					gchsEntityDeletableTable=readFromJDBC(connection,pIdEntDelTable);
					if (gchsEntityDeletableTable!=null)
					{
						putObjectInCaches(gchsEntityDeletableTable);
						pkCache.markAsLoaded();
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static GchsEntityDeletableTable read(final java.sql.Connection connection, final long pIdEntDelTable)
	throws
		java.sql.SQLException
	{
		return (isCacheEnabled())
			? readFromCache(connection,pIdEntDelTable)
			: readFromJDBC(connection,pIdEntDelTable)
		;
	}
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	private static java.util.Collection<GchsEntityDeletableTable> loadFromCache(final java.sql.Connection connection)
	throws
		java.sql.SQLException
	{
		synchronized(pkCache)
	 ...
	 * @exception java.sql.SQLException If a JDBC error occurs.
	 */
	public static java.util.Collection<GchsEntityDeletableTable> loadSQL(final java.sql.Connection connection, final java.lang.String sql1, final java.lang.String sql2, java.util.Collection<GchsEntityDeletableTable> collection)
	throws
		java.sql.SQLException
	{
	 ...
	 */
	protected static class SQLIterator extends isf.persistence.AbstractSQLIterator<GchsEntityDeletableTable>
	{
		/**
		 ...
		 */
		@java.lang.Override
		protected GchsEntityDeletableTable create(final java.sql.ResultSet rs)
		throws
			java.sql.SQLException
		{
			final GchsEntityDeletableTable gchsEntityDeletableTable=new GchsEntityDeletableTable();
			gchsEntityDeletableTable.loadResultSet(rs);
			return gchsEntityDeletableTable;
		}
